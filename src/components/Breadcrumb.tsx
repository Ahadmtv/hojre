                ...
                <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    <div>
                        <li className="inline-flex items-center">
                            <Link to="/" className="inline-flex items-center text-lg font-medium text-gray-800 hover:text-amber-400 font-vazir-thin">
                            ...
                            <div key={i}>
                                {!isLast &&
                                    <li aria-current="page">
                                        <Link to={pathLinks} className="inline-flex items-center text-lg font-medium text-gray-800 hover:text-amber-400 font-vazir-thin">

      ...
      <div className="bg-orange-50">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-x-10 p-10">
          <div className="flex justify-center items-center">
            <div className="">
              <img src="./assets/images/about/03.png"></img>
            </div>
          </div>
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="mt-10 flex flex-col gap-y-3">
              <div className="flex">
                <div className="flex justify-center items-start w-[10%]"><img className="rounded-full w-full" src="./assets/images/about/icon/01.jpg"></img></div>
              ...
              <div className="flex">
                <div className="flex justify-center items-start w-[10%]"><img className="rounded-full w-full" src="./assets/images/about/icon/02.jpg"></img></div>
                <div className="pr-2 font-vazir-thin w-[90%]">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز </div>
              </div>
              <div className="flex">
                <div className="flex justify-center items-start w-[10%]"><img className="rounded-full w-full" src="./assets/images/about/icon/03.jpg"></img></div>
                <div className="pr-2 font-vazir-thin w-[90%]">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز </div>
              </div>
            </div>
          </div>
